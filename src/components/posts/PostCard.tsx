  ...
  return (
    <div className="p-6 bg-white shadow-sm rounded-lg border border-green-50 hover:shadow-md hover:border-gray-300 transition-all duration-200 overflow-hidden">
      ...
      <div className="mb-3 flex items-center gap-1 text-xs text-gray-600">
        <span className="px-2.5 py-0.5 rounded border border-gray-200 bg-green-50/50 tracking-tight ">UserId: {post.userId}</span>
        <span className="px-2.5 py-0.5 rounded border border-gray-200 bg-amber-50/50 tracking-tight ">PostId: {post.id}</span>
      </div>
      ...
      <div className="space-y-3 mb-6">
        <div className="flex items-center text-sm text-gray-800">
          ...
          {user ? (
            ...
            <span className="font-medium truncate">ID: {post.userId}</span>
          )}
        </div>
        {user ? (
          <div className="flex items-center text-sm text-gray-800">
